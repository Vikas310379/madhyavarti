...
import { MailIcon, PhoneIcon, UserIcon, MessageCircleIcon, SendIcon, CheckCircleIcon, AlertCircleIcon } from './ui/Icons';
    ...
    <div className="w-full max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10 text-center">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-2">If you have any questions or comments, please email us at</p>
          <div className="font-medium text-gray-900">info@madhyavartithebroker.com</div>
        </div>
      </div>
